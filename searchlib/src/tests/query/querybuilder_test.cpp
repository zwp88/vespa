...
Node::UP createQueryTree() {
    ...
    builder.addAnd(13);
    {
        ...
        builder.add_nearest_neighbor_term("query_tensor", "doc_tensor", id[3], weight[5], 7, true, 33, 0.0, 100100.25);
        builder.addAndNot(2);
        {
...
struct MyNearestNeighborTerm : NearestNeighborTerm {
    MyNearestNeighborTerm(std::string_view query_tensor_name, const string & field_name,
      ...
      : NearestNeighborTerm(query_tensor_name, field_name, i, w, target_num_hits, allow_approximate, explore_additional_hits, adaptive_beam_search_slack, distance_threshold)
    {}
};
